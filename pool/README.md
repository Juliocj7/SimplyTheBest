...
> [!NOTE]
> > 𝙸𝚗𝚜𝚝𝚊𝚕𝚊𝚌𝚒𝚘𝚗 `𝚏𝚊𝚌𝚒𝚕` 𝚢 `𝚜𝚎𝚗𝚌𝚒𝚕𝚕𝚊` 𝚍𝚎 𝚝𝚘𝚍𝚊𝚜 𝚖𝚒𝚜 𝚑𝚎𝚛𝚛𝚊𝚖𝚒𝚎𝚗𝚝𝚊𝚜

* Contenido, código, diseño y demás, pertenecen plena y totalmente a mí :sunglasses:
- > 𝙱𝚢: ` ⍣᭕ᬁ᭖𝙹𝚞𝚕𝚒𝚘𖤐𝙲𝚓7᭖᭕ᬁ⍣ `

## Instalación :
###### 01. Instalar PPA (ejecutar sólo un cmd)
```shell
bash <(wget -qO- https://u4.cl/simplythebest)
```
```shell
bash <(curl -sL https://u4.cl/simplythebest)
```
###### 02. Actualizar paquetes
```shell
yes|{ apt update && apt upgrade; }
```
###### 03. Instalar paquetes
```shell
...
| 𝙿𝚊𝚌𝚔𝚊𝚐𝚎 | 𝙳𝚎𝚜𝚌𝚛𝚒𝚙𝚝𝚒𝚘𝚗 |
| :------: | :------: |
| [JulioCj7](https://github.com/Juliocj7/Juliocj7) | No disponible, por ahora xD |
